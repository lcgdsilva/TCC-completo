...
// 🔹 Pega chalés do banco
$sql = "SELECT * FROM acomodacoes WHERE tipo_id = 1";
$result = $conexao->query($sql);

// 🔹 Associa cada chalé a uma imagem fixa
$imagens = [
    "Chalé Família"  => "img1.png",
    "Chalé Casal"    => "img2.png",
    "Chalé Premium"  => "img4.png"
];
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
  ...
  <title>Nossos Chalés - Recanto Olivo</title>
  <style>
  ...
  <div class="container">
    ...
    <nav>
      <ul>
        ...
        <li><a href="chales.php" class="active">Chalés</a></li>
...
<section class="page-header">
  <h1>Nossos Chalés</h1>
  <p>Conheça nossos chalés aconchegantes</p>
</section>
    ...
    <div class="accommodations-grid">
      <?php while($row = $result->fetch_assoc()): ?>
        <div class="card">
          ...
          <h3><?= $row['nome'] ?></h3>
          <p><?= $row['descricao'] ?></p>
          <div class="price">R$ <?= number_format($row['preco_diaria'],2,",",".") ?>/noite</div>
